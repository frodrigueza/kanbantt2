class IndicatorsController < ApplicationController
  ...
  private
    ...
    def indicator_params
      params.require(:indicator).permit(:date, :real_days_progress, :expected_days_progress, :real_resources_progress, :expected_resources_progress, :real_used_resources, :expected_used_resources)
    end
end
