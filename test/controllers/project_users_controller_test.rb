...
class ProjectUsersControllerTest < ActionController::TestCase
  ...
  test "should create project_user" do
    assert_difference('ProjectUser.count') do
      post :create, project_user: { project_id: @project_user.project_id, role: @project_user.role, user_id: @project_user.user_id }
    end
  ...
  test "should update project_user" do
    patch :update, id: @project_user, project_user: { project_id: @project_user.project_id, role: @project_user.role, user_id: @project_user.user_id }
    assert_redirected_to project_user_path(assigns(:project_user))
  end
